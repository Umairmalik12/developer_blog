...
export function WhatsAppChat({ phoneNumber, welcomeMessage = "Hello! How can I help you today?" }: WhatsAppChatProps) {
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-all hover:bg-[#20c35c]"
        ...
        <div className="fixed bottom-24 right-6 z-50 w-80 overflow-hidden rounded-lg bg-white shadow-xl">
          ...
          <div className="flex items-center justify-between bg-[#25D366] px-4 py-3 text-white">
            ...
            <button
              ...
              className="rounded-full p-1 hover:bg-[#20c35c]"
