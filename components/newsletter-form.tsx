...
import { getFromLocalStorage, setToLocalStorage } from "@/lib/storage-helpers"
...
export function NewsletterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Use our safe localStorage helpers
      const subscribers = getFromLocalStorage<any[]>("newsletter_subscribers", [])
      subscribers.push({
        email,
      ...
      setToLocalStorage("newsletter_subscribers", subscribers)
